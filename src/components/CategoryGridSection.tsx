        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {CATEGORIES.map((cat, idx) => (
            <motion.div
              ...
              className="group cursor-pointer bg-white rounded-2xl border border-[#E8D5A8] p-4 sm:p-5 shadow-xs hover:shadow-[0_12px_28px_rgba(240, 90, 126,0.09)] hover:border-[#F05A7E] transition-all flex flex-col justify-between"
            >
              {/* Image Container with Soft Pink Background */}
              <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-[#FCE8ED] mb-4 border border-[#E8D5A8]/60">
                <img
                  src={cat.image}
                  alt={cat.name}
