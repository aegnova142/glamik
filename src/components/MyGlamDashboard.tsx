...
export const MyGlamDashboard: React.FC<MyGlamDashboardProps> = ({
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen text-[#121212] py-10 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="border-b border-[#E8D5A8] pb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              onClick={() => {
                setAuthModalInitialTab('customer');
              ...
              title="Customer Login / Switch Profile"
            >
              <LogIn className="w-3.5 h-3.5 text-[#C9972B]" />
              <span>{currentUser ? 'SWITCH USER' : 'SIGN IN / LOGIN'}</span>
            </button>

            {/* Admin CMS Portal Access Button */}
            <button
              onClick={() => {
                if (onNavigateAdmin) {
                  onNavigateAdmin();
              ...
              className="px-4 py-3 bg-[#171717] text-[#FAF9F6] border border-[#E8D5A8]/40 text-xs font-semibold tracking-wider uppercase hover:bg-[#F05A7E] hover:border-[#F05A7E] transition-all flex items-center gap-2 shadow-sm cursor-pointer"
              title="Access Admin Content Atelier CMS"
            >
              <ShieldCheck className="w-3.5 h-3.5 text-[#E3B84B]" />
          ...
          >
            {profile ? (
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                {/* Account & Admin Sign In Access Box */}
                <div className="p-6 sm:p-8 bg-[#171717] border border-[#E8D5A8]/40 rounded-xl text-[#FAF9F6] space-y-5 shadow-lg">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#E8D5A8]/20 pb-4">
                    <div>
                      <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#C9972B]">
                        GLAMIRK ATELIER ACCESS
                      </span>
                      <h3 className="font-serif text-xl sm:text-2xl text-[#FAF9F6]">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-4 py-2 bg-[#C9972B] hover:bg-[#E3B84B] text-[#0B0B0B] text-xs font-bold uppercase tracking-wider rounded transition-all cursor-pointer shadow-sm flex items-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#F05A7E] hover:bg-[#E3B84B] hover:text-[#0B0B0B] text-[#FFFFFF] text-xs font-bold uppercase tracking-wider rounded transition-all cursor-pointer shadow-sm flex items-center gap-1.5"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="p-4 bg-[#0B0B0B] border border-[#E8D5A8]/20 rounded-lg space-y-2">
                      <div className="flex items-center gap-2 text-[#C9972B] font-bold uppercase tracking-wider text-[11px]">
                        <User className="w-3.5 h-3.5" />
                        <span>Customer Suite</span>
                      </div>
                      <p className="text-[#6B6B6B] text-[11px] leading-relaxed">
                        Access your order tracking, shade quiz matches, saved addresses &amp; 480 Privé points.
                      </p>
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="w-full py-2 bg-[#171717] hover:bg-[#C9972B]/20 text-[#FAF9F6] border border-[#E8D5A8]/30 rounded text-[11px] font-semibold transition-colors cursor-pointer"
                      >
                        ⚡ 1-Click Demo Login (Aanya Sen)
                      </button>
                    </div>

                    {/* Admin Atelier Info */}
                    <div className="p-4 bg-[#0B0B0B] border border-[#F05A7E]/30 rounded-lg space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 text-[#F05A7E] font-bold uppercase tracking-wider text-[11px]">
                          <ShieldCheck className="w-3.5 h-3.5" />
                          <span>Admin Atelier</span>
                        </div>
                        <span className="text-[10px] text-[#E3B84B] font-mono">Full Access</span>
                      </div>
                      <p className="text-[#6B6B6B] text-[11px] leading-relaxed">
                        Manage products, banners, offers countdown, FAQs, pages &amp; palette tokens.
                      </p>
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="w-full py-2 bg-[#F05A7E] hover:bg-[#E3B84B] hover:text-[#0B0B0B] text-[#FFFFFF] font-bold rounded text-[11px] uppercase tracking-wider transition-colors cursor-pointer"
                      >
      ...
      {/* Global Authentication Modal (Customer / Admin) */}
      <AuthModal
