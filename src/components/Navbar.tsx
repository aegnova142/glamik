              ...
              <AnimatePresence>
                {accountMenuOpen && (
                  ...
                  >
                    ...
                    {/* Admin CMS Option */}
                    <div className="p-2 bg-[#0B0B0B]/60">
                      <button
                        onClick={() => {
                          setAccountMenuOpen(false);
                          if (onNavigateAdmin) {
                        ...
                        className="w-full text-left px-3 py-2.5 rounded-lg bg-[#F05A7E]/15 hover:bg-[#F05A7E] text-[#F05A7E] hover:text-white border border-[#F05A7E]/30 flex items-center justify-between transition-all cursor-pointer group"
                      >
                        <div className="flex items-center gap-2.5">
                          <ShieldCheck className="w-4 h-4 text-[#F05A7E] group-hover:text-white" />
                          <div>
                            <span className="font-bold text-xs block">Admin CMS Portal</span>
                            <span className="text-[10px] text-[#FAF9F6]/70 group-hover:text-white">tryweb@gmail.com</span>
                          </div>
                        </div>
                        <span className="text-[10px] font-mono uppercase bg-[#0B0B0B]/50 px-1.5 py-0.5 rounded text-[#E3B84B]">
                          Login
                        </span>
                      </button>
                    </div>
          ...
          {activeMegaMenu && (
            ...
            >
              <div className="max-w-7xl mx-auto px-8 grid grid-cols-12 gap-8">
                ...
                {/* Column 3: Diagnostic & Sets */}
                <div className="col-span-3 space-y-3">
                  <div className="flex items-center justify-between border-b border-[#E8D5A8] pb-2">
                    <h4 className="text-sm font-bold text-[#121212] uppercase tracking-wider">
                      AI &amp; Sets
                    </h4>
                    <span className="text-[10px] bg-[#F05A7E] text-white font-bold px-2 py-0.5 rounded-full">
                      Smart
                    </span>
                  </div>
                  <ul className="space-y-2.5 text-[13px] text-[#6B6B6B]">
                    <li>
                      <button
                        ...
                        className="hover:text-[#F05A7E] transition-colors text-left font-medium text-[#F05A7E] flex items-center gap-1.5"
                      >
                        <Sparkles className="w-3.5 h-3.5" /> Find My Shade Diagnostic
                      </button>
                    </li>
                    <li>
                      <button
                    ...
                    <li>
                      <button
                        ...
                        className="hover:text-[#F05A7E] transition-colors text-left"
                      >
                        Curated Looks &amp; Festive Edits
                      </button>
                    </li>
                    <li className="pt-1">
                      <button
                        onClick={() => handleShopNavigation(null, null)}
                        className="text-[#121212] font-bold hover:text-[#F05A7E] transition-all text-xs flex items-center gap-1"
                      >
                        <span>Shop All Creations ({cartCount > 0 ? `${cartCount} in Bag` : 'Full Catalog'})</span>
                        <ArrowRight className="w-3 h-3" />
                      </button>
                    </li>
                  </ul>
                ...
                {/* Column 4: Quick Atelier Spotlight */}
                <div className="col-span-3 bg-[#FCE8ED] p-5 rounded-2xl border border-[#E8D5A8] flex flex-col justify-between">
                  <div>
